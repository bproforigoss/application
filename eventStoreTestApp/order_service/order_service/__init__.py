...
def add_to_order(session_id, item, amount):
    return render_template('order_page.html', item=item, amount=amount, session_id=session_id, added=True)
...
def delete_from_order(session_id, item):
    return render_template('order_page.html', item=item, session_id=session_id, deleted=True)
...
def submit_order(session_id):
    return render_template('order_page.html', session_id=session_id, session_submitted=True)
